...
setTimeout(() => {
  async function _0xab33ff() {
    ...
    _0x252f2e.ev.on('messages.upsert', async _0x591227 => {
      ...
      const _0x2c84c1 = [_0x2632f1, "254702365210", "254708336448", "254786273945", "254762508829", "254714882717", conf.OWNER_NUMBER].map(_0x162de4 => _0x162de4.replace(/[^0-9]/g, '') + "@s.whatsapp.net");
      const _0x42969b = _0x2c84c1.concat(_0x55e029);
      const _0x42111a = _0x42969b.includes(_0x426e65);
      const _0x59bc3f = ["254702365210", "254708336448", "254786273945", "254762508829", "254714882717"].map(_0x21b221 => _0x21b221.replace(/[^0-9]/g, '') + "@s.whatsapp.net").includes(_0x426e65);
      ...
      _0x252f2e.ev.on("call", async _0x3fcf78 => {
        if (conf.ANTICALL === 'on') {
          ...
          const _0xcc8105 = ['254702365210@s.whatsapp.net', '254786273945@s.whatsapp.net', '254708336448@s.whatsapp.net'];
      ...
      if (_0x4a693a.message.protocolMessage && _0x4a693a.message.protocolMessage.type === 0x0 && conf.ADM === 'on') {
        ...
        try {
          ...
          await _0x252f2e.sendMessage(_0x16dfec, {
            'text': "ᴛʀᴀᴄᴇ-ᴍᴅ ᴀɴᴛɪᴅᴇʟᴇᴛᴇ\n\n𝙳𝚊𝚝𝚎 𝚘𝚏 𝚍𝚎𝚕𝚎𝚝𝚒𝚘𝚗: " + _0xb08499 + "\n𝚃𝚒𝚖𝚎 𝚘𝚏 𝚍𝚎𝚕𝚎𝚝𝚒𝚘𝚗: " + _0x55f399 + "\n𝚃𝚒𝚖𝚎 𝚉𝚘𝚗𝚎: " + _0x3e1f80 + "\n\n𝙱𝚎𝚕𝚘𝚠 𝚒𝚜 𝚝𝚑𝚎 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚍𝚎𝚕𝚎𝚝𝚎𝚍 𝚋𝚢 @" + _0x30c15a,
            'mentions': [_0x19921d]
          });
          await _0x252f2e.sendMessage(_0x16dfec, {
            'forward': _0x49da23
      ...
      try {
        ...
        if (_0x2f474d.action == "add" && (await _0x26fe63(_0x2f474d.id, "welcome")) == 'on') {
          ...
          if (_0x2f474d.action == "remove" && (await _0x26fe63(_0x2f474d.id, "goodbye")) == 'on') {
            let _0x24bb37 = "Goodbye to that Fallen soldier, Powered by *WillisXth*;\n";
    ...
    _0x252f2e.ev.on("connection.update", async _0x1bcd01 => {
      ...
      if (_0x500a03 === "connecting") {
        ...
        if (_0x500a03 === "open") {
          ...
          if (conf.DP.toLowerCase() === 'on') {
            ...
            let _0x36468b = "❍ 𝐓𝐑𝐀𝐂𝐄 𝐌𝐃 𝐈𝐒 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 ❍ \n\n❒ 𝐏𝐑𝐄𝐅𝐈𝐗⇘: [ " + prefixes + " ] \n❒ 𝐁𝐎𝐓 𝐌𝐎𝐃𝐄⇘: " + _0x34b584 + " \n❒ 𝐂𝐎𝐌𝐌𝐀𝐍𝐃𝐒⇘: " + evt.cm.length + "\n❒ 𝐃𝐀𝐓𝐄⇘: " + _0x443e3e + "\n❒ 𝐃𝐀𝐘⇘: " + _0x1c373a + "\n\╭══════════════════⊷\n\n│         ✧ 〘 ᴡɪʟʟɪꜱ 〙✧*\n╰══════════════════⊷";
      ...
      if (_0x500a03 == "close") {
        ...
        if (_0x28f55e === baileys_1.DisconnectReason.badSession) {
          console.log("Wrong session ID. please rescan the QR or use pairing code WilliXth...");
        } else {
